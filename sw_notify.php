    ...
    function sw_notify()
    {
        ...
        foreach ($resultdm as $rowdm) {
            ...
            foreach ($result2 as $row2) {
                $email_array[$row2->user_email] .= "{$row2->region} has a high risk of <a href='http://13.54.13.233/wordpress/index.php/dm-management/'> Downy Mildew </a> on {$rowpm->forecast_day}, {$rowdm->forecast_date}.<br/>";
            }
        }
        ...
        foreach ($resultgm as $rowgm) {
            ...
            foreach ($result3 as $row3) {
                $email_array[$row3->user_email] .= "{$row3->region} has a high risk of <a href='http://13.54.13.233/wordpress/index.php/gm-management/'> Grey Mould </a> on {$rowpm->forecast_day}, {$rowdm->forecast_date}.<br/>";
            }
        }
